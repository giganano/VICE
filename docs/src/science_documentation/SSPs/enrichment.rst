...
star cluster's formation [3]_, the entire CCSN net yield is injected within 
...
asymptotic giant branch (AGB) stars is injected according to [4]_: 

.. math:: \dot{M}_x^\text{AGB}\Delta t \approx 
	y_x^\text{AGB}(m_\text{postMS}(t), Z)M_\star
	\left[h(t) - h(t + \Delta t)\right] 

and from type Ia supernovae (SN Ia) according to [5]_: 
...
.. [3] See the discussion of :ref:`enrichment from CCSNe <enr_ccsne>` for 
	justification of this assumption. 

.. [4] Justification of this can be found :ref:`here <enr_agb>`. 

.. [5] Justification of this can be found :ref:`here <enr_sneia>`. 
