...
class hydrodiskstars: 
	...
	.. note:: Simulations which adopt this model that run for longer than 
		12.7 Gyr are not supported. Stellar populations in the built-in 
		hydrodynamical simulation data span 12.7 Gyr of ages. 
	...
	* ValueError 
		...
		- Maximum radius < 20 
	* ScienceWarning 
		- This object is called with a time larger than 12.7 Gyr 
	...
	def mode(self): 
		...
		- "linear" 
			Orbital radii at times between birth and 12.7 Gyr are assigned via 
		...
		- "sudden" 
			...
			between when a stellar population is born and 12.7 Gyr. At times 
		...
		- "diffusion" 
			The orbital radius at times between birth and 12.7 Gyr are assigned 
