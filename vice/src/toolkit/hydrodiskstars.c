...
static unsigned long candidate_search(HYDRODISKSTARS hds, double birth_radius,
	 ...
	 * OpenMP threads. Although the body of the for-loop is largely within a
	 # *pragma omp critical bloack to ensure thread safety, most calls to
	 * assess_candidate will fail quickly, with individual threads spending
	 * most of their time outside of the critical block. This approach results
	 * in significant speed boosts for this function.
	 */
