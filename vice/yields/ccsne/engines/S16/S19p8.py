r"""
This file implements the S19.8 explodability engine as a function of progenitor
...
class S19p8(engine):
	...
	r"""
	S19.8 core collapse supernova explosion engine as reported by Sukhbold et al.
	(2016) [1]_.
	...
	**Signature**: from vice.yields.ccsne.engines.S16 import S19p8
	...
	assigned according to the S19.8 explosion engine. See the associated
	...
	def __init__(self):
		masses, frequencies = read("%syields/ccsne/engines/S16/S19p8.dat" % (
			_DIRECTORY_))
