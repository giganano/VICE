r"""
This file implements the W15 explodability engine as a function of progenitor
...
class W15(engine):
	...
	r"""
	W15 core collapse supernova explosion engine as reported by Sukhbold et al.
	(2016) [1]_.
	...
	**Signature**: from vice.yields.ccsne.engines.S16 import W15
	...
	assigned according to the W15 explosion engine. See the associated
	...
	def __init__(self):
		masses, frequencies = read("%syields/ccsne/engines/S16/W15.dat" % (
			_DIRECTORY_))
