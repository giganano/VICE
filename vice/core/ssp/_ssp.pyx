...
def single_stellar_population(element, mstar = 1e6, Z = 0.014, time = 10, 
	...
	* IOError [Only occurs if VICE's file structure has been modified] 
	...
	# Take into account future deprecation of the keyword arg "agb_model" 
	# simply unmask the block above and below to adopt deprecation. 
...
# 	Code masked for future compatabilitiy 
