...
__all__ = ["atomic_number", "ccsne_yields", "sneia_yields", "solar_z", 
	"sources"]
...
#----------------- CORE COLLAPSE SUPERNOVAE YIELDS DATAFRAME -----------------# 
ccsne_yields = _du._customizable_yield_table({
	"c":	2.36e-3, 
	"n":	5.78e-4, 
	"o":	5.64e-3, 
	"f":	5.15e-8, 
...
#-------------------- TYPE IA SUPERNOVAE YIELDS DATAFRAME --------------------# 
sneia_yields = _du._customizable_yield_table({
	"c":	5.74e-6, 
	"n":	6.43e-9, 
	"o":	5.79e-5, 
	"f":	8.21e-14, 
