...
def feuillet2018_amr(ax, element): 
...
def main(output, stem): 
	...
	median_ages(ax1, "O", "H", output, 7, 9, 0, 0.5) 
	median_ages(ax2, "Fe", "H", output, 7, 9, 0, 0.5, label = True) 
	feuillet2019_amr(ax1, "O", "H", 7, 9, 0, 0.5) 
	feuillet2019_amr(ax2, "Fe", "H", 7, 9, 0, 0.5, label = True) 
	feuillet2018_amr(ax1, 'o') 
	feuillet2018_amr(ax2, 'fe') 
	kwargs = {
		"ncol": 			1, 
		"frameon": 			False, 
		"fontsize": 		20, 
